...
//--- - - -------------------  - -- - - - - - - -- - - - -- - - - --  tables
//--- - - -------------------  - -- - - - - - - -- - - - -- - - - -- - - -- 
static location global_locations[1024];
static long long global_locations_bits[16];
static location*global_locations_ptr=global_locations;
static long long*global_locations_bits_ptr=global_locations_bits;
//--- - - -------------------  - -- - - - - - - -- - - - -- - - - -- - - -- 
static entity global_entities[1024];
static long long global_entities_bits[16];
static entity*global_entities_ptr=global_entities;
static long long*global_entities_bits_ptr=global_entities_bits;
//--- - - -------------------  - -- - - - - - - -- - - - -- - - - -- - - -- 
//--- - - -------------------  - -- - - - - - - -- - - - -- - - - -- - funcs

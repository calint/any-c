...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	location_get_name, .-location_get_name
	.type	location_set_name, @function
location_set_name:
.LFB7:
	.cfi_startproc
	pushq	%rbp
	...
	.cfi_endproc
.LFE7:
	.size	location_set_name, .-location_set_name
...
.LFB8:
	...
	.cfi_endproc
.LFE8:
	.size	entity_set_location, .-entity_set_location
	.section	.rodata
.LC0:
	.string	""
.LC1:
...
.LFB9:
	...
	leaq	.LC1(%rip), %rsi
	movq	%rax, %rdi
	call	location_set_name
	movq	$0, -16(%rbp)
	leaq	-24(%rbp), %rdx
	leaq	-16(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	entity_set_location
	movq	-16(%rbp), %rax
	movq	%rax, %rdi
	call	location_get_name
	movq	%rax, %rsi
	leaq	.LC2(%rip), %rdi
	movl	$0, %eax
	call	printf@PLT
